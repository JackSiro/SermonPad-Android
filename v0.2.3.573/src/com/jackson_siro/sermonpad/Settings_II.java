...
public class Settings_II extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {	
		...
		Long first_use = vSettings.getLong("sp_first_data", 0);
	    Long expiry_data = vSettings.getLong("sp_expire_data", 0);
	    ...
	    if (my_remsecs < 0) {
	    	Expiration_Date = "This Trial Mode of SermonPad expires is expired!";
	    }
	    if (my_remsecs < 60) {
	    	Expiration_Date = "This Trial Mode of SermonPad expires " + 
		...
		if (PreferenceManager.getDefaultSharedPreferences(this).getBoolean("sp_is_paid", true))
		{
