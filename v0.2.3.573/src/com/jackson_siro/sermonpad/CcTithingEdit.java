...
public class CcTithingEdit extends ActionBarActivity {
	...
	private void DeleteThis(){
		AlertDialog.Builder builder = new AlertDialog.Builder(CcTithingEdit.this);
		...
		builder.setPositiveButton("Amen", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface arg0, int arg1) {
				...
				startActivity(new Intent(CcTithingEdit.this, BbListSermon.class));
        		finish();
			}
		});
